...
FUNCTION_MAP = {
    ...
    "max_valence": get_max_valence,
    "min_valence": get_min_valence,
    "sd_valence": get_sd_valence,
    "max_arousal": get_max_arousal,
    "min_arousal": get_min_arousal,
    "sd_arousal": get_sd_arousal,
    "max_dominance": get_max_dominance,
    "min_dominance": get_min_dominance,
    "sd_dominance": get_sd_dominance,
    ...
    "max_emotion_intensity": get_max_emotion_intensity,
    "min_emotion_intensity": get_min_emotion_intensity,
    "sd_emotion_intensity": get_sd_emotion_intensity,
    # ENTITY FEATURES
    ...
    "sd_concreteness": get_sd_concreteness,
    # AoA
    "avg_aoa": get_avg_aoa,
    ...
    "sd_prevalence": get_sd_prevalence,
    # Socialness
    ...
    "sd_socialness": get_sd_socialness,
    # Iconicity
    ...
    "sd_sensorimotor": get_sd_sensorimotor,
...
FEATURE_LEXICON_MAP = {
    ...
    "n_high_intensity": {**{key: "intensity_nrc" for key in LANGUAGES_NRC},
                         **{"en": "intensity_nrc"}},
    "max_valence": {**{key: "vad_nrc" for key in LANGUAGES_NRC},
                    **{"en": "vad_nrc"}},
    "min_valence": {**{key: "vad_nrc" for key in LANGUAGES_NRC},
                    **{"en": "vad_nrc"}},
    "sd_valence": {**{key: "vad_nrc" for key in LANGUAGES_NRC},
                   **{"en": "vad_nrc"}},
    "max_arousal": {**{key: "vad_nrc" for key in LANGUAGES_NRC},
                    **{"en": "vad_nrc"}},
    "min_arousal": {**{key: "vad_nrc" for key in LANGUAGES_NRC},
                    **{"en": "vad_nrc"}},
    "sd_arousal": {**{key: "vad_nrc" for key in LANGUAGES_NRC},
                   **{"en": "vad_nrc"}},
    "max_dominance": {**{key: "vad_nrc" for key in LANGUAGES_NRC},
                      **{"en": "vad_nrc"}},
    "min_dominance": {**{key: "vad_nrc" for key in LANGUAGES_NRC},
                      **{"en": "vad_nrc"}},
    "sd_dominance": {**{key: "vad_nrc" for key in LANGUAGES_NRC},
                     **{"en": "vad_nrc"}},
    "max_emotion_intensity": {**{key: "intensity_nrc" for key in LANGUAGES_NRC},
                              **{"en": "intensity_nrc"}},
    "min_emotion_intensity": {**{key: "intensity_nrc" for key in LANGUAGES_NRC},
                              **{"en": "intensity_nrc"}},
    "sd_emotion_intensity": {**{key: "intensity_nrc" for key in LANGUAGES_NRC},
                             **{"en": "intensity_nrc"}},
    ...
    "avg_concreteness": {"en": "concreteness_brysbaert",
                         ...
                         "es": "affective_norms_guasch",
                         "pl": "concreteness_imbir"},
    ...
    "max_concreteness": {"en": "concreteness_brysbaert",
                         ...
                         "es": "affective_norms_guasch",
                         "pl": "concreteness_imbir"},
    "sd_concreteness": {"en": "concreteness_brysbaert",
                        "fr": "concreteness_bonin",
                        "de": "leipzig_affective_norms",
                        "it": "affective_norms_montefinese",
                        "es": "affective_norms_guasch",
    ...
    "sd_prevalence": {"en": "prevalence_brysbaert"},
    ...
    "sd_iconicity": {"en": "iconicity_winter"},
    ...
    "max_sensorimotor": {"en": "sensorimotor_lancaster",
                         "it": "sensorimotor_vergallito"},
    "sd_sensorimotor": {"en": "sensorimotor_lancaster",
                        "it": "sensorimotor_vergallito"},
}
