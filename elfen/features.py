...
from .lexical_richness import (
    ...
    get_global_lemma_hapax_dislegomena,
    get_global_token_hapax_dislegomena,
    get_lexical_density,
    get_hdd,
    get_sichel_s,
    get_global_sichel_s,
...
FUNCTION_MAP = {
    ...
    "global_lemma_hapax_dislegomena": get_global_lemma_hapax_dislegomena,
    "global_token_hapax_dislegomena": get_global_token_hapax_dislegomena,
    "hdd": get_hdd,
